...
| Arquivo | Formato | Para que serve no Azul Finanças |
|---------|---------|---------------------|
| `historico_atendimento.csv` | CSV | Contextualizar interações anteriores, ou seja, dar continuidade ao atendimento de forma mais eficiente. |
| `perfil_investidor.json` | JSON | Personalizar recomendações e explicações sobre as dúvidas do cliente. |
| `produtos_financeiros.json` | JSON | Explicar e sugerir produtos adequados ao perfil do cliente. |
...
O produto FII (Fundo de investimento imobiliário substituiu o fundo multimercado por se tratar de um produto mais conhecido.
